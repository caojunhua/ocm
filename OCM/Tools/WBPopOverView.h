...
- (instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(float)height Direction:(WBArrowDirection)direction onView:(UIView *)view;//初始化

- (void)popViewToView:(UIView *)view;//弹出视图
- (void)dismiss;//隐藏视图
- (void)addTableView:(UITableView *)tableView;//添加tableview

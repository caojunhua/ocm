...
//}
QuadTreeNodeData QuadTreeNodeDataForAMapPOI(OCMAllNetDetailItem* poi)
{
    return QuadTreeNodeDataMake(poi.chLatitude, poi.chLogngitude, (__bridge_retained void *)(poi));
}
...
//    CLLocationDegrees maxY = ((AMapPOI *)pois[0]).location.longitude;
    CLLocationDegrees minX = ((OCMAllNetDetailItem *)pois[0]).chLatitude;
    CLLocationDegrees maxX = ((OCMAllNetDetailItem *)pois[0]).chLatitude;
    
    CLLocationDegrees minY = ((OCMAllNetDetailItem *)pois[0]).chLogngitude;
    CLLocationDegrees maxY = ((OCMAllNetDetailItem *)pois[0]).chLogngitude;
...
//        AMapPOI *aPoi = (__bridge AMapPOI *)data.data;
        OCMAllNetDetailItem *aPoi = (__bridge OCMAllNetDetailItem *)data.data;
//        CLLocationCoordinate2D coordinate = CLLocationCoordinate2DMake(aPoi.location.latitude, aPoi.location.longitude);
        CLLocationCoordinate2D coordinate = CLLocationCoordinate2DMake(aPoi.chLatitude, aPoi.chLogngitude);

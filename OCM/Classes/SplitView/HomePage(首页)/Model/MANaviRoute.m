...
//        NSArray *polylineColors = @[[UIColor purpleColor]];
...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.routeColor = [UIColor purpleColor];
        self.walkingColor = [UIColor cyanColor];
        self.railwayColor = [UIColor redColor];
        self.driveColor = [UIColor orangeColor];
        self.trafficColors = @[[UIColor yellowColor], [UIColor blueColor], [UIColor blueColor], [UIColor redColor]];
    }

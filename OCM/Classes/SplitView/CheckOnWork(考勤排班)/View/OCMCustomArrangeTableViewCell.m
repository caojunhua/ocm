...
@implementation OCMCustomArrangeTableViewCell
...
- (void)config {
    ...
    [self.arrangeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [self.subTitleL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(weakSelf.textField2.mas_right).offset(20);
        make.centerY.mas_equalTo(weakSelf.textField2.mas_centerY);
    }];
    [self.superTaskL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(weakSelf.subTitleL.mas_right).offset(12);
        make.centerY.mas_equalTo(weakSelf.subTitleL.mas_centerY);
        make.width.mas_equalTo(120);
        make.height.mas_equalTo(28);
    }];
    [self.subTaskL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(weakSelf.superTaskL.mas_right).offset(12);
        make.centerY.mas_equalTo(weakSelf.superTaskL.mas_centerY);
        make.width.mas_equalTo(120);
        make.height.mas_equalTo(28);
    }];

...
//    self.leftArrCount         = self.dataSourceArr.count;
}
- (void)viewDidLoad {
...
- (void)configTableView:(CGFloat)width {
    ...
    UIView *sepV                        = [[UIView alloc] initWithFrame:CGRectMake(kLeftWidth - 1, 0, 1, self.view.height)];
    sepV.backgroundColor                = [UIColor colorWithHexString:@"666666"];
